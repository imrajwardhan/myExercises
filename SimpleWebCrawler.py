#Creating a Scrappy project and Custom spider

# This web crawler is developed using Scrapy library
# Following code is for a custom spider

#To execute the crawler use command "scrapy crawl spider_name" from command prompt or terminal
#This is just the basic code for a single spider in a project, you can create multiple spiders for a project
